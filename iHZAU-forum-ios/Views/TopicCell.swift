    ...
    var data: Topic? {
        didSet {
            if let data = data {
                ...
                /**/
//                let _str = NSString(string: data.user.avatarUrl.absoluteString)
//                let _strr:String = _str.substring(to: _str.length-5)
//                let _str1:NSString = NSString(string: _strr.appending("md"))
//                data.user.avatarUrl = URL(string: String(_str1))
                /**/
                let imageurl = data.user.avatarUrl.absoluteString
                let url = URL(string: ROOT_URL + imageurl)
